...
class Users::OmniauthCallbacksController < Devise::OmniauthCallbacksController
  ...
  #카카오 로그인
  def kakao
    redirect_to "https://kauth.kakao.com/oauth/authorize?client_id=#{ENV['KAKAO_REST_API_KEY']}&redirect_uri=https://gongin-mat-zip-wonwon.c9users.io/users/auth/kakao/callback&response_type=code"
  end
  ...
  def kakao_auth
    ...
    base_response = RestClient.post(base_url,{grant_type: 'authorization_code',
                                              ...
                                              redirect_uri: 'https://gongin-mat-zip-wonwon.c9users.io/users/auth/kakao/callback',
                                              code: code})
